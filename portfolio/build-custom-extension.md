...
For more information about the OpenAPI specification, see [OpenAPI Specification](https://swagger.io/specification/).
...
**Tip:** The [SwaggerHub](https://swagger.io/tools/swaggerhub/) website offers an [OpenAPI 3.0 Tutorial](https://support.smartbear.com/swaggerhub/docs/tutorials/openapi-3-tutorial.html), as well as [tools](https://swagger.io/tools/) to help you develop and validate your OpenAPI document. You can use the online [Swagger editor](https://editor.swagger.io/) to convert your OpenAPI document to the correct format and OpenAPI version.
...
- [Relative URLs](https://swagger.io/docs/specification/api-host-and-base-path/#relative-urls) are currently not supported.
